...
<!--     <header class="page-header"> -->
	...
	<section class="section section1">
		<div class="container-fluid">
			...
			<table class="table text-center leasing-table" style="vertical-align: center;">
						<thead>
							<tr>
								<th class="bodycopy greentext text-center">Building One<br><span class="footertext">2333 Waukegan Rd.</span></th>
								<th class="bodycopy greentext text-center">Building Two<br><span class="footertext">2345 Waukegan Rd.</span></th>
								<th class="bodycopy greentext text-center">Building Three<br><span class="footertext">2355 Waukegan Rd.</span></th>
								<th class="bodycopy greentext text-center">Building Four<br><span class="footertext">2201 Waukegan Rd.</span></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="bodycopy darktext"><?php the_field('building_one_available_square_footage'); ?></td>
								<td class="bodycopy darktext"><?php the_field('building_two_available_square_footage'); ?></td>
								<td class="bodycopy darktext"><?php the_field('building_three_available_square_footage'); ?></td>
								<td class="bodycopy darktext"><?php the_field('building_four_available_square_footage'); ?></td>
							</tr>
						</tbody>
					</table>
